...
export const initialComments: Comment[] = [
  {
    ...
    score: 12,
    user: { image: amyrobson, username: 'amyrobson' },
    replies: [],
  },
  {
    id: 2,
    ...
    score: 5,
    user: { image: maxblagun, username: 'maxblagun' },
    replies: [
      {
        id: 3,
        content:
        ...
        user: { image: ramsesmiron, username: 'ramsesmiron' },
      },
      {
        id: 4,
        content:
        ...
        user: { image: juliusomo, username: 'juliusomo' },
      },
    ],
  },
]
